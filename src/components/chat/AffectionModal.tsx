          ...
          <div className="rounded-2xl border border-[#2d303b] bg-gradient-to-b from-[#21232d] to-[#191a21] p-5 shadow-lg relative overflow-hidden">
            ...
            <div className="mt-4 space-y-2">
              <div className="flex items-center justify-between text-xs">
                <span className="font-semibold text-zinc-300">Tiến trình hảo cảm</span>
                <span className={`font-mono font-bold text-sm ${themeConfig.badgeText}`}>
                  {affectionScore} <span className="text-zinc-500 text-xs font-normal">/ 100</span>
                </span>
              </div>
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              <span className="text-xs font-bold uppercase tracking-wider text-zinc-300 flex items-center gap-1.5">
                ...
                <span>5 Cột Mốc Tình Cảm & Đặc Quyền Mở Khóa</span>
              </span>
              <span className="text-[11px] text-zinc-500">Mối quan hệ tự động tiến triển</span>
            </div>
